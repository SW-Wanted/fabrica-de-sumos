...
#include "include/Fila.c"
#include "include/Maquina.h"
#include "include/Maquina.c"
#include "include/Pilha.h"
#include "include/Pilha.c"
...
void gerarRelatorio(Pilha *pilhaEmbalamentoPA, Pilha *pilhaEmbalamentoPB, int descartadosPA, int descartadosPB)
{
    ...
    sprintf(nomeFicheiro, "reports/relatorio_simulacao_%04d-%02d-%02d_%02d-%02d-%02d.txt", tm.tm_year + 1900, tm.tm_mon + 1, tm.tm_mday, tm.tm_hour, tm.tm_min, tm.tm_sec);
